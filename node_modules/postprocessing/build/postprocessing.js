...
var POSTPROCESSING = (() => {
  ...
  function getTextureDecoding(texture, isWebGL2) {
    ...
    if (texture !== null) {
      ...
      const sRGB8Alpha8 = revision >= 133 && isWebGL2 && texture.format === import_three52.RGBAFormat && texture.type === import_three52.UnsignedByteType && texture.encoding === import_three52.sRGBEncoding;
      if (!sRGB8Alpha8) {
